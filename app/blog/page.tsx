    ...
    <>
      <div className="bg-black">
        ...
        <div className="bg-black relative text-white min-h-screen px-4 md:px-[80px] py-8">
          ...
          {/* Title */}
          <h1 className="text-3xl relative z-10 font-sans md:text-5xl font-bold max-w-[750px]">
          ...
          <div className="max-w-[1080px] mx-auto">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="mt-[60px] text-[28px]  text-white font-serif max-w-[1280px]">
                ...
                blandit eleifend.. Nisl in arcu nunc faucibus vitae erat
              ...
              {[1, 2].map((item) => (
                <div key={item}>
                  ...
                  <p className="text-[#ADADAD] text-[16px] md:text-[20px] mt-2">
                    ...
                    pharetra rhoncus.. Tincidunt ipsum sed mattis elit ut
                    aliquam.. Nisl ut vulputate dolor ut eu amet.. Eu nullam
                    volutpat orci ut nisi.. Nunc maecenas sit sit ipsum
                    pretium.. Dui erat sed maecenas integer. Posuere aliquet eu
                    sit tempor convallis sed ac.. Turpis condimentum ut duis
